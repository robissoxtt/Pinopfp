...
const accessories = {
  ...
  clothes: ['clothes (1).png', 'clothes (2).png', 'clothes (3).png', 'clothes (4).png', 
            ...
            'clothes (9).png','clothes (10).png',
            'clothes (11).png','clothes (12).png', 'clothes (13).png','clothes (14).png', 
            'clothes (15).png','clothes (16).png', 'clothes (17).png','clothes (18).png', 
            'clothes (19).png','clothes (20).png','clothes (21).png','clothes (22).png',
            'clothes (23).png'],
